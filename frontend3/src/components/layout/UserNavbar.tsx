...
export default function UserNavbar({ 
  ...
  // Use React Query hooks like admin navbar
  ...
  const navLinks = [
    ...
    { to: "/user/capteurs", label: "Capteurs" },
    { to: "/user/cliniques", label: "Cliniques" },
    { to: "/user/alertes", label: "Alertes" },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center">
            <NavLink to="/user/dashboard" className="flex items-center gap-3 transition-opacity hover:opacity-80">
